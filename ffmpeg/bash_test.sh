...
# ====================================== 用剪好的片段组合
BODY_SEGMENT=("cut/body/body1.mp4" "cut/body/body2.mp4" "cut/body/body3.mp4")
HOOK_VIDEOS=("cut/hook/hook1.mp4" "cut/hook/hook2.mp4" "cut/hook/hook3.mp4") 
# ====================================== 传一个body去裁剪
...
for body in "${BODY_SEGMENT[@]}"; do
    ...
    body_file="$OUTPUT_DIR/tmp/$body_name.mp4" 
...
for hook in "${HOOK_VIDEOS[@]}"; do
    ...
    hook_name="${hook_base%.*}"
    hook_file="$OUTPUT_DIR/tmp/$hook_name.mp4"
    extension="${hook##*.}" 
...
for hook_file in "${hook_files[@]}"; do
    ...
    echo "file '$(realpath "$hook_file")'" > "$tmp_list"
